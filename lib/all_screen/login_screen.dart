            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Welcome To sabbus'.tr,style:  TextStyle(fontFamily: 'SofiaProBold',fontSize: 16,color: notifier.textColor)),
                ...
                from12?.agentStatus == "1" ? InkWell(
                    onTap: () {
                      bottomSheet("AGENT",'Enlist as a sabbus Partner now!');
                    },
                    child: Text("Join us as a sabbus Partner today!".tr,style: const TextStyle(fontFamily: 'SofiaProBold',fontSize: 13,color: Colors.green))
                ) : const SizedBox(),
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      children: [
                        ...
                        Text('sabbus'.tr,style: TextStyle(color: notifier.theamcolorelight,fontSize: 20,fontFamily: 'SofiaProBold'),),
                      ],
                    ),
